        ...
        <div key={field.id} className="space-y-4 p-4 border rounded-lg">
          ...
          <div>
            ...
            {errors.education?.[index]?.institution && (
              <p className="text-red-500">{errors.education[index]?.institution?.message as string}</p>
            )}
          </div>
          <div>
            ...
            {errors.education?.[index]?.diploma && (
              <p className="text-red-500">{errors.education[index]?.diploma?.message as string}</p>
            )}
          </div>
          <div>
            ...
            {errors.education?.[index]?.year && (
              <p className="text-red-500">{errors.education[index]?.year?.message as string}</p>
            )}
          </div>
          <div>
            ...
            {errors.education?.[index]?.location && (
              <p className="text-red-500">{errors.education[index]?.location?.message as string}</p>
            )}
          </div>
        </div>
      ))}
      <Button type="button" onClick={() => append({ institution: "", diploma: "", year: "", location: "" })}>
